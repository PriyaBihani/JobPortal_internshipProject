            ...
            <div className="frame">
                ...
                <div ng-app ng-init="checked = false">
                    <form className="form-signin" name="form">
                        ...
                        <input className="form-styling" type="text" name="email" placeholder="" onChange={handleForm}/>
                        <label for="password">Password</label>
                        <input className="form-styling" type="text" name="password" placeholder="" onChange={handleForm}/>
